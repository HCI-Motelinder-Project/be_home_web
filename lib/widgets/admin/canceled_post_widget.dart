...
class CanceledPostWidget extends StatefulWidget {
  final RentItemModel model;
  final Function function;

  const CanceledPostWidget({Key key, this.model, this.function})
      : super(key: key);

  @override
  _CanceledPostWidgetState createState() => _CanceledPostWidgetState();
}

const status = {"Unavailable": "Đã xóa", "Rejected": "Xác thực không thành"};

class _CanceledPostWidgetState extends State<CanceledPostWidget> {
