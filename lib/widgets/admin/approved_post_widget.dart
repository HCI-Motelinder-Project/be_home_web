...
class ApprovedPostWidget extends StatefulWidget {
  final RentItemModel model;
  final Function function;

  const ApprovedPostWidget({Key key, this.model, this.function})
      : super(key: key);

  @override
  _ApprovedPostWidgetState createState() => _ApprovedPostWidgetState();
}

class _ApprovedPostWidgetState extends State<ApprovedPostWidget> {
                  ...
                  children: [
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                          onTap: () async {
                            widget.model.status = "Unavailable";
